...
export default function EshanyaMarketPage() {
  const brand = "Eshanya Trade Links";
  ...
  return (
    <div className="eshanya-root">
      ...
      <footer className="eshanya-footer"><div><a className="eshanya-brand footer-brand" href="#top"><span className="eshanya-mark">ET</span><span><strong>ESHANYA</strong><small>TRADE LINKS</small></span></a><p>Global connections. Lasting trust.</p></div><div><span>Business portal</span><a href="https://app.vitharn.com/eshanya_trade_links/home">Open business portal <ArrowRight size={14} /></a></div><div><span>Established in</span><strong>Coimbatore, India</strong></div></footer>
    </div>
  );
}
